...
public class Electron implements GameObject {
    ...
    public void update() {
        ...
        if(m_pos[0] < -.3 ) {
            m_PlayerModel.collide(-90,m_playerPhysics);
        ...
        if (m_pos[1] > .7){
            m_PlayerModel.collide(0,m_playerPhysics);
            m_playerPhysics.collide(0);
        }
        if (m_pos[1] < -.7){
            m_PlayerModel.collide(180,m_playerPhysics);
            m_playerPhysics.collide(180);
        }
        /*if (m_pos[1] < m_pos[0]){
            m_PlayerModel.collide(135,m_playerPhysics);
            m_playerPhysics.collide(135);
        }*/
